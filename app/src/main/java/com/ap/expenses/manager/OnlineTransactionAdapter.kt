...
class OnlineTransactionAdapter(
    private var transactions: List<OnlineTransaction>,
    private val listener: OnTransactionClickListener
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {

    interface OnTransactionClickListener {
        fun onEditClick(transaction: OnlineTransaction)
        fun onDeleteClick(transaction: OnlineTransaction)
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is DateHeaderViewHolder) {
            ...
            with(holder.binding) {
                ...
                tvTimeAndApp.text = "$timeText via ${transaction.paymentApp}"
    ...
    fun updateData(newTransactions: List<OnlineTransaction>) {
